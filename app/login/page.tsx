...
export default async function LoginPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[430px] flex-col justify-center px-5 py-8">
      ...
      <div className="space-y-4">
        <Card>
          ...
          <form action={loginAction} className="mt-4 space-y-3">
            <input name="email" type="email" required placeholder={t("auth.email")} className="w-full rounded-2xl border border-app-border bg-white px-4 py-3 outline-none focus:border-good-green" />
            <input name="password" type="password" required placeholder={t("auth.password")} className="w-full rounded-2xl border border-app-border bg-white px-4 py-3 outline-none focus:border-good-green" />
        ...
        <Card>
          ...
          <form action={registerAction} className="mt-4 space-y-3">
            <input name="displayName" type="text" placeholder={t("auth.displayName")} className="w-full rounded-2xl border border-app-border bg-white px-4 py-3 outline-none focus:border-good-green" />
            <input name="email" type="email" required placeholder={t("auth.email")} className="w-full rounded-2xl border border-app-border bg-white px-4 py-3 outline-none focus:border-good-green" />
            <input name="password" type="password" required minLength={6} placeholder={t("auth.password")} className="w-full rounded-2xl border border-app-border bg-white px-4 py-3 outline-none focus:border-good-green" />
