      ...
      <div className="space-y-6">
        <header className="rounded-[34px] border border-white/75 bg-white/90 p-5 shadow-card backdrop-blur-xl">
          ...
          <div className="mt-5 space-y-1">
            <h1 className="text-3xl font-black tracking-[-0.04em] text-text-primary">{t("progress.title")}</h1>
            <p className="text-base leading-7 text-text-secondary">{t("progress.subtitle")}</p>
          </div>
        </header>
